    ...
    */
    ...
    public void ataque(Personaje j, Personaje e){   //puede atacar el jugador o el enemigo
        ...
        if (e.getHabilidad() == "suerte" && dE == 1){
            while (dE == 1) dE = Juego.rollDice(20);
        }
        ...
        if (e.getEstado() == 'd'){
            ...
            if (e.getHabilidad() == "suerte" && dE2 == 1){
                while (dE2 == 1) dE2 = Juego.rollDice(20);
            }
        ...
        System.out.println(e.getNombre() + "'s constitution bonus +" + e.getConstitucion() );
    ...
    public void defender(){
        this.setEstadoClass('d'); //cambiar en otras clases
    }
